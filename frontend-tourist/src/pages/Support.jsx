...
// Lightweight "Contact support" entry point — support_tickets /
// support_ticket_messages existed in schema.sql with no route or UI at all.
// Not meant to be elaborate: open a ticket, see your own, reply on one.
// Admin views/responds/closes from the admin console (routes/admin.js).
...
function NewTicketForm({ onCreated }) {
  ...
  async function handleSubmit(e) {
    ...
    setSuccess('');
    try {
      const res = await openSupportTicket({ subject, message });
